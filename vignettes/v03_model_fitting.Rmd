...
This object contains 5 elements:

- `gibbs_samples` is a list of the raw samples from the Gibbs sampler,

- `gibbs_samples_n` is the normalized version of `gibbs_samples`,

- `gibbs_samples_nb` are the elements of `gibbs_sample_n` after the burn-in period,

- `gibbs_samples_nt` are the thinned elements of `gibbs_sample_n`,

- and `gibbs_samples_nbt` are the Gibbs samples used for parameter estimates, i.e. the normalized and thinned Gibbs samples after burn-in.
