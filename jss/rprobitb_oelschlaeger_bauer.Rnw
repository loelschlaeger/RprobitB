...
Overall, the average berserking frequencies of the players in classes 1 to 3 are 0.03, 0.28, and 0.51. The correlations between the observed berserking frequencies and the class probabilities over all players are -0.52, 0.34, and 0.52 for classes 1 to 3, respectively.
