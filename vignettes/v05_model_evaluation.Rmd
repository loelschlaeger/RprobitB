...
vignette [Model specification and variants][v02] relates how much a student
smokes to age and exercise; the comparison below asks whether the exercise
dummies improve the prediction.
...
smoking_age <- update(smoking_full, . ~ Age)
loo::loo_compare(
