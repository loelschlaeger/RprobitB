...
This vignette defines the probit model implemented in RprobitB.

## The probit model assumptions
...
## Linking the latent utilities to the choices
...
[^1]: For notational simplicity, the number of choice occasions $T$ is assumed to be the same for each decision maker here. However, RprobitB allows for unbalanced panels, i.e. varying $T$.
