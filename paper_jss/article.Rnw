...
\title{RprobitB: Bayes Estimation of Latent Class Mixed Multinomial Probit Models}
\Plaintitle{RprobitB: Bayes Estimation of Latent Class Mixed Multinomial Probit Models}
\Shorttitle{RprobitB}
