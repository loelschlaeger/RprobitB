#' Construct object of class \code{RprobitB_scale}.
#' @description
#' This function constructs an object of class \code{RprobitB_scale}.
#' @details
#' Per default, the first error-term variance is fixed to \code{1}, i.e.
#' \code{scale = list("parameter" = "s", "index" = 1, "value" = 1)}.
#' Note that you can set \code{"parameter" = "a"} only if the model has
#' parameters with a fixed coefficient (i.e. \code{P_f>0}).
...
#' }
#' @examples
#' RprobitB_scale(scale = NULL, P_f = 2, J = 3)
#' @return
#' An object of class \code{RprobitB_scale}, which is of the form \code{scale}.

RprobitB_scale = function(scale, P_f, J) {
